...
dir.create(file.path(wd, "cls_lei", "RNA"), recursive = TRUE)
write.table(RNA_seurat@active.ident, file="cls_lei/RNA/lei_r08", row.names=TRUE, col.names=FALSE, sep="\t", quote = FALSE)
```
