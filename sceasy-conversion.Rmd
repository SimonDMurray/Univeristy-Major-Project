...
RNA_seurat <- readRDS(paste(wd, "RNA_seurat_analysis_output/integrated_seurat", "full_seurat.rds", sep="/"))
```

```{r}
# Reading in ADT object written to file by integration analysis notebook
ADT_seurat <- readRDS(paste(wd, "ADT_seurat_analysis_output/integrated_seurat", "full_seurat.rds", sep="/"))
```
