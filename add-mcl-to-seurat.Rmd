...
dir.create(file.path(wd, "ADT_seurat_analysis_output", "mcl_integrated_seurat"), recursive = TRUE)
saveRDS(ADT_seurat, paste(wd, "ADT_seurat_analysis_output/mcl_integrated_seurat", "seurat.rds", sep="/"))
```

```{r}
# Saving the seurat object so it can easily be read in for future analysis
dir.create(file.path(wd, "RNA_seurat_analysis_output", "mcl_integrated_seurat"), recursive = TRUE)
saveRDS(RNA_seurat, paste(wd, "RNA_seurat_analysis_output/mcl_integrated_seurat", "seurat.rds", sep="/"))
```